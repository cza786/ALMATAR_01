...
const caps = [
  ['02_integrated_drilling_rig.png', 'Directional Drilling'],
  ['03_directional_well_trajectory.png', 'Casing Running'],
  ['04_well_construction_cross_section.png', 'Cementing Support'],
  ['06_field_operations_drilling_site.png', 'Workover Operations'],
  ['01_hero_well_intervention.png', 'Rig Support Services'],
  ['05_right_well_background.png', 'Wellbore Optimization'],
];

export default function DrillingWorkoverPage() {
  return (
    <div className="total-field-page drilling-page">
      <section className="tf-hero"><img src={`${base}01_drilling_workover_hero.png`} alt="Drilling and workover services" /><div className="tf-hero-copy"><span>RELIABLE OPERATIONS. LONG-TERM VALUE.</span><h1>DRILLING AND<br />WORKOVER SERVICES</h1><p>Safe, efficient and technically advanced drilling and workover solutions to unlock the full potential of your assets.</p><a href="#drilling-capabilities">REQUEST TECHNICAL SUPPORT　→</a></div><span className="tf-hero-side">PEOPLE<br />TECHNOLOGY<br />PERFORMANCE</span></section>
      ...
      <section className="tf-people"><article><img src={`${base}03_field_operations_team.png`} alt="Experienced drilling team" /><div><small>FIELD OPERATIONS</small><h2>People on the Ground.<br />Performance in the Field.</h2><p>Our experienced crews and modern equipment deliver safe and efficient drilling and workover operations in challenging environments.</p></div></article><article><img src={`${base}07_hse_worker_rig.png`} alt="HSE and quality operations" /><div><small>HSE &amp; QUALITY</small><h2>Safety. Quality. Always.</h2><p>We are committed to conducting our drilling and workover operations with the highest standards of Health, Safety, Environment and Quality.</p></div></article></section>
      ...
      <NextPageBanner title="LET'S DRIVE YOUR NEXT PROJECT FORWARD" subtitle="Get in touch with our technical team to discuss your drilling and workover requirements." link="/contact" bgImage={`${base}08_footer_cta_workers.png`} />
    </div>
  );
}
