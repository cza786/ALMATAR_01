...
const caps = [
  ['02_integrated_drilling_rig.webp', 'Directional Drilling'],
  ['03_directional_well_trajectory.webp', 'Casing Running'],
  ['04_well_construction_cross_section.webp', 'Cementing Support'],
  ['06_field_operations_drilling_site.webp', 'Workover Operations'],
  ['01_hero_well_intervention.webp', 'Rig Support Services'],
  ['05_right_well_background.webp', 'Wellbore Optimization'],
];
