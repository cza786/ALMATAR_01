...
const content = {
  ...
  ar: {
    ...
    intro: { eyebrow: 'الهندسة والسلامة التشغيلية', title: 'حلول متكاملة للعزل الطبقي', description: 'تقدم شركة المطار خدمات هندسية للإسمنت وعزل الآبار لحماية الإنتاج والأصول والبيئة طوال دورة حياة البئر.', imageAlt: 'مخطط إسمنت البئر', button: 'تعرّف على شركة المطار' },
