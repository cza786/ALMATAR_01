...
export default function WellInterventionPage() {
  return <div className="well-intervention-page">
    <section className="wi-hero">
      <img src={`${base}well-intervention-hero-clear.png`} alt="Well intervention rig operating in an oilfield" />
    ...
    <section className="wi-lifecycle">
      ...
      </div><img className="wi-lifecycle-image" src={`${base}intervention-lifecycle-clear.png`} alt="Intervention lifecycle technical diagram" />
    </section>
    ...
    <section className="wi-sustainability"><img src={`${base}sustainability-background-clear.png`} alt="Sustainable field operations" /><div><h2>SAFETY. PEOPLE.<br />A SUSTAINABLE TOMORROW.</h2><p>At Almatar, we believe in delivering energy solutions responsibly – for our people, our partners and the communities where we operate.<br />Our well intervention services are designed to create lasting value while protecting people and the environment.</p><Link href="/about" className="wi-outline-btn">OUR SUSTAINABILITY　→</Link></div></section>
