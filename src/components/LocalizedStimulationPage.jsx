...
const copy = {
  ...
  ar: {
    ...
    overview: 'تصمم شركة المطار وتنفذ برامج تنشيط مخصصة تحسن اتصال المكمن وتدعم إنتاجاً موثوقاً. نجمع الهندسة والمعدات والتنفيذ الميداني المنضبط ضمن فريق واحد مسؤول.',
    ...
    nextSubtitle: 'تواصل مع شركة المطار',
  },
};
