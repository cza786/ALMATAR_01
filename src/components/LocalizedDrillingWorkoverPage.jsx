...
const copy = {
  ...
  ar: {
    ...
    introEyebrow: 'تميز هندسي', introTitle: 'حلول متكاملة للحفر وصيانة الآبار', introDescription: 'تقدم المطار عمليات حفر وصيانة آبار آمنة وفعالة وذات جدوى اقتصادية، بالاعتماد على أساليب مثبتة وفرق خبيرة ومعدات حديثة. صُممت حلولنا لتحقيق أهداف الآبار المعقدة مع الحفاظ على سلامة البئر وإنتاجية المكمن والقيمة طويلة الأمد.',
...
export default function LocalizedDrillingWorkoverPage() {
  ...
  return <div className="total-field-page drilling-page">
    ...
    <NextPageBanner title={text.ctaTitle} subtitle={text.ctaDescription} link="/contact" bgImage={`${base}08_footer_cta_workers.webp`} />
  </div>;
}
