...
export default function TradingPage() {
  ...
  const rawCommitments = t('trading.commitments') || [];
  const icons = [
    (
  ...
  const commitmentItems = rawCommitments.map((item, idx) => ({
    ...item,
    icon: icons[idx % icons.length]
  }));

  const rawIndustries = t('trading.industries') || [];
  const indIcons = [
    (
  ...
  const industriesWeServe = rawIndustries.map((ind, idx) => ({
    ...ind,
    icon: indIcons[idx % indIcons.length]
  }));
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="tr-main-grid">
            ...
            <div className="tr-what-col">
              <h2 className="tr-col-heading">{t('trading.whatWeTrade')}</h2>
              <div className="tr-col-accent" />
              <p className="tr-col-lead">
                {t('trading.whatWeTradeLead')}
              </p>
            ...
            <div className="tr-commitment-col">
              <h2 className="tr-col-heading">{t('trading.ourCommitment')}</h2>
              <div className="tr-col-accent" />
      ...
      <section className="tr-industries-section">
        <div className="container">
          <h2 className="tr-industries-heading">{t('trading.industriesWeServe')}</h2>
